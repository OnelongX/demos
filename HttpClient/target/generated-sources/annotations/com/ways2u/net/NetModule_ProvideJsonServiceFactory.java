...
public final class NetModule_ProvideJsonServiceFactory implements Factory<JsonService> {
  ...
  public NetModule_ProvideJsonServiceFactory(
      NetModule module,
  ...
  public static Factory<JsonService> create(
      ...
      Provider<String> baseUrlProvider,
      Provider<Converter.Factory> converterProvider) {
    return new NetModule_ProvideJsonServiceFactory(
